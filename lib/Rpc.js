    ...
    if (o.scriptPubKey.asm.indexOf("SSGEN") > -1 ) {
        ...
        if (config.network == 'dcrdlivenet') {
          ...
          if (parseInt(hexLE, 16) == 4) {
            ...
            var lnsupport = 'LN: ';
            var sdiff = 'DCP0001: ';
            switch (parseInt(agendasLE, 16)&lnsupportMask) { case 0x02: lnsupport +='no';break;   case 0x04: lnsupport +='yes';break;   default: lnsupport=''; }
            switch (parseInt(agendasLE, 16)&sdiffMask) { case 0x08: sdiff +='no';break;  case 0x10: sdiff +='yes';break;   default: sdiff=''; }
            if (lnsupport != '') {
          ...
          if (parseInt(hexLE, 16) == 5) {
            var sdiffMask=0x06;
            var choice = 'DCP0001: ';
            switch (parseInt(agendasLE, 16)&sdiffMask) { case 0x02: choice += 'no';break;  case 0x04: choice +='yes';break;   default: choice=''; }
            if (choice != '') {
