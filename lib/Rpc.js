  ...
  info.vout.forEach( function(o) {
    ...
    if (o.scriptPubKey.asm.indexOf("SSGEN") > -1 ) {
        ...
        if (config.network == 'dcrdlivenet') {
          ...
          var sdiffMask=0x18;
          var lnsupport = 'abstain';
          var sdiff = 'abstain';
          switch (versionBits&lnsupportMask) { case 0x02: lnsupport='no';   case 0x04: lnsupport='yes';   default: lnsupport='abstain'; }
          switch (versionBits&sdiffMask) { case 0x08: sdiff='no';  case 0x10: sdiff='yes';   default: sdiff='abstain'; }
          info.agendas = {lnSupport: lnsupport, sDiff: sdiff};
        } else if (config.network == 'dcrdtestnet') {
          var sdiffMask=0x06;
          var sdiff = 'abstain';
          switch (versionBits&sdiffMask) { case 0x02: sdiff='no';  case 0x04: sdiff='yes';   default: sdiff='abstain'; }
          info.agendas = {sDiff: sdiff};
        }
